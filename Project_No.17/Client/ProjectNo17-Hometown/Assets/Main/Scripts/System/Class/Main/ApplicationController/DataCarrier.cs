...
namespace TFSystem
{
	public static partial class DataCarrier
	{
		...
		public static void SetData(string currentEpisodeName, object episodeName_Start)
		{
		...
		public struct SeparateData
		{
			...
			{
				separateKey = key;
				data = new SaveLoadKeyValue(separateKey);
			}
		}
	}
}