...
namespace TFSystem
{
	public class SystemController : ComponentBehaviour, ISystemController
	{
		...
		protected override void BaseAwake()
		{
			...
			systemStateCollector = OdccQueryCollector.CreateQueryCollector(OdccQueryBuilder.SimpleQueryBuild<SystemState>()).GetCollector();
		}

		TSystem GetSystemState<TSystem>() where TSystem : class, IOdccObject
		{
			var list = systemStateCollector.GetQueryItemList();
