...
namespace TFContent
{
	public class SaveLoadTimelineController : MonoBehaviour, OldISaveLoadTarget
	{
		[Serializable]
		...
		public string Save()
		{
			...
			return JsonUtility.ToJson(timelineControllerData);
		}

		public void Load(OldISaveLoadTarget.SaveLoadData loadData)
		{
