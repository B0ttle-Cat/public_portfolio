...
namespace TFContent
{
	public class GameContentLoader : OdccBehaviorTarget, IGameContentLoader
	{
		...
		private void OnValidate()
		{
			...
			if(scenarioObjectData) scenarioObjectData.OnValidate();
			if(iffMatchingInfoData) iffMatchingInfoData.OnValidate();
		}
		...
		protected override async Awaitable OnActionUpdate()
		{
			...
			DataCarrier.GetSeparate<GameContentLoader>().SetData<IFFMatchingInfoData>(iffMatchingInfoData);
		}
