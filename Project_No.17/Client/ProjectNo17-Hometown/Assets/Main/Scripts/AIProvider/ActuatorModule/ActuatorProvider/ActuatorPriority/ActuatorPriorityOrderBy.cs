...
namespace BC.Actuator
{
	...
	{
		/// <seealso cref="FormulaExternalGroup.ActuatorProvider.ActuatorPriorityFormulaIndex"/>
		[Serializable]
		public abstract class ActuatorPriorityOrderBy
		{
			...
			[SerializeField, PropertyOrder(-9998), HorizontalGroup("Title"), HideLabel, SuffixLabel("NormalizeScale", overlay: true), MinValue(0f)]
