...
namespace BC.AIProvider
{
	public interface ICombatCompute : IOdccComponent
	{
		...
		public SensorProvider FindSensorProvider(int index);
		public IFFProvider FindIFFProvider(int index);
		public ROCProvider FindROCProvider(int index);
		...
		public SensorProvider FindSensorProvider(ObjectBehaviour target) => FindSensorProvider(FindObjectIndex(target));
		public IFFProvider FindIFFProvider(ObjectBehaviour target) => FindIFFProvider(FindObjectIndex(target));
		public ROCProvider FindROCProvider(ObjectBehaviour target) => FindROCProvider(FindObjectIndex(target));
