...
{
	public partial class ActuatorEffect//.Editor
	{
		...
		[FoldoutGroup("SampleTest")]
		[ShowInInspector, TextArea(0, 10), HideLabel, PropertyOrder(97)]
		private string FullFormulaText {
			get {
				if(UnityEditor.Selection.activeObject is not ActuatorEffect thisEffect) return "";
				var list = thisEffect.EffectInfoList;
		...
		[FoldoutGroup("SampleTest")]
		[HorizontalGroup("SampleTest/TestSample"), SerializeField, ShowInInspector, PropertyOrder(98)]
		...
		[FoldoutGroup("SampleTest")]
		[ButtonGroup("SampleTest/TestSampleA"), SerializeField, ShowInInspector, PropertyOrder(99)]
		private void InitAbilityType()
		{
			// ActuatorFormulaAbility
			// AbilityType ability;
			HashSet<AbilityType> allAbilityType = new HashSet<AbilityType>();
			for(int i = 0 ; i < EffectInfoList.Length ; i++)
			{
				string formulaJson = JsonUtility.ToJson(EffectInfoList[i].FormulaSystem, true);
		...
		[FoldoutGroup("SampleTest")]
		[ButtonGroup("SampleTest/TestSampleB"), SerializeField, ShowInInspector, PropertyOrder(99)]
		...
		[FoldoutGroup("SampleTest")]
		[HorizontalGroup("SampleTest/TestSample2"), ShowInInspector, PropertyOrder(100), HideLabel]
		private string SampleResult { get; set; }
		[FoldoutGroup("SampleTest")]
		[HorizontalGroup("SampleTest/TestSample2"), HideLabel, InlineButton("TestFormula"), ShowInInspector, PropertyOrder(101)]
		...
		public void TestFormula()
		{
			...
			void _TestFormula(ActuatorEffectInfo effectInfo)
			{
			...
			float _GetAbility(GetterType getter, AbilityType ability) => getter switch {
				GetterType.Order => thisEffect.TestOrder.GetValue(ability),
				GetterType.Target => thisEffect.TestTarget.GetValue(ability),
				_ => 0
			};
		...
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), InlineButton("GenerateHistogram")]private int numberOfSamples = 10000;
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200)] private bool minIsZero;
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200)] private Vector2Int minMaxCount = Vector2Int.up;
		private Vector2Int minMaxCountRange = Vector2Int.up;
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar0"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar0 = 0; private string nameBar0 = "0";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar1"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar1 = 0; private string nameBar1 = "1";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar2"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar2 = 0; private string nameBar2 = "2";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar3"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar3 = 0; private string nameBar3 = "3";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar4"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar4 = 0; private string nameBar4 = "4";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar5"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar5 = 0; private string nameBar5 = "5";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar6"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar6 = 0; private string nameBar6 = "6";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar7"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar7 = 0; private string nameBar7 = "7";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar8"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar8 = 0; private string nameBar8 = "8";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("@nameBar9"), ProgressBar("@minMaxCountRange.x", "@minMaxCountRange.y") ]private int countBar9 = 0; private string nameBar9 = "9";
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200)] private Vector2 minMaxValue = Vector2.up;
		[FoldoutGroup("SampleTest/RepeatHistogram"), ShowInInspector, PropertyOrder(200), LabelText("전체 평균"), ProgressBar("@minMaxValue.x", "@minMaxValue.y",BackgroundColorGetter = "#FFFFFF")] private float resultAverage = 0f;
		private void GenerateHistogram()
		{
			...
			{
				value = 0f;
				if(UnityEditor.Selection.activeObject is not ActuatorEffect thisEffect) return false;
				...
				return false;
				bool _TestFormula(ActuatorEffectInfo effectInfo, out float value)
				{
					if(effectInfo.TryCalculate(_GetAbility, _GetEffectType, out float result))
					{
						value = result;
