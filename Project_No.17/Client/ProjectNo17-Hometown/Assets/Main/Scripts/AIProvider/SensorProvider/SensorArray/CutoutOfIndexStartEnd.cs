...
//		protected override void SensorUpdate(SensorProvider self, ref NativeSlice<SensorProvider.SensoringData> dataList)
//		{
...
//				if(start > 0)
//				{
//					dataList = new NativeSlice<SensorProvider.SensoringData>(dataList, 0, start);
//					end -= start; // End 위치 조정
//				}
//				if(end < listLength - 1)
//				{
//					dataList = new NativeSlice<SensorProvider.SensoringData>(dataList, end + 1, listLength - (end + 1));
//				}
//			}
//			else // ExcludeRange
//			{
